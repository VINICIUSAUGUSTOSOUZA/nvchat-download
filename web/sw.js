const CACHE='nvchat-web-v7';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./icon.svg','./assets/app.css','./assets/app.js','./assets/search.js','../assets/supabase-config.js'];
